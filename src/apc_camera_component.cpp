...
namespace dmpreview
{
    ...
    void ApcCamera::getModeConfig(int mode)
    {
        ...
        else
        {
            ...
            {
            case 8:
                depth_raw_data_type = modeConfig.bRectifyMode ? libeYs3D::video::DEPTH_RAW_DATA_TYPE::DEPTH_RAW_DATA_8_BITS : libeYs3D::video::DEPTH_RAW_DATA_TYPE::DEPTH_RAW_DATA_8_BITS_RAW;
                break;
            case 11:
                depth_raw_data_type = modeConfig.bRectifyMode ? libeYs3D::video::DEPTH_RAW_DATA_TYPE::DEPTH_RAW_DATA_11_BITS : libeYs3D::video::DEPTH_RAW_DATA_TYPE::DEPTH_RAW_DATA_11_BITS_RAW;
                break;
            case 14:
                depth_raw_data_type = modeConfig.bRectifyMode ? libeYs3D::video::DEPTH_RAW_DATA_TYPE::DEPTH_RAW_DATA_14_BITS : libeYs3D::video::DEPTH_RAW_DATA_TYPE::DEPTH_RAW_DATA_14_BITS_RAW;
                break;
            }
        }

        if ((device_->getCameraDeviceInfo().devInfo.wPID == 0x120 || device_->getCameraDeviceInfo().devInfo.wPID == 0x137) && modeConfig.D_Resolution.Height == 360)
        {
        ...
        moduleModeConfig_.colorFormat = modeConfig.eDecodeType_L == ModeConfig::MODE_CONFIG::YUYV ? libeYs3D::video::COLOR_RAW_DATA_YUY2 : libeYs3D::video::COLOR_RAW_DATA_MJPG;
